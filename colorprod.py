...
def main():
    path_img = 'pictures/IMG_2686.jpg'
    ...
    mask = setRangeColor(hsv, lower_Orange, lower_Orange)
    contours = contours_img(mask)
    color_bbox = (0,0,255)
    img_draw, count_orange = filter_counters_img(contours, img_draw, color_bbox)
    print('Orange Count : ', count_orange)

    cv2.imwrite('pictures/IMG_2686.png', img_draw)
